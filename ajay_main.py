...
#Takig the input of Rows
Row = int(input('Enter number of Row - \n'))

#Taking the input of Seats
...
#While Loop for Selecting options
while x != 0:
    ...
    if x == 1:
        ...
        print('No. of purchased Ticket - ', Booked_seat)
        ...
        if Enter_row in range(1, Row+1) and Enter_column in range(1, Seats+1):
            ...
            print()
            print('***  Current Option is Incorrect  ***')
        print()
